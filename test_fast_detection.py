...
while True:
    ...
    cv2.rectangle(img,(0,0), (120,480), (0,0,0), -1) #Dibuja Barras 
    cv2.putText(img, str(N_frames), (100,100), cv2.FONT_HERSHEY_SIMPLEX, 2, (255,255,255), 3)  #Dibuja Texto con ID       
    cv2.imshow("Slow Motion", img)
